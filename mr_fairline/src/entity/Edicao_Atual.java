...
public class Edicao_Atual {

	private int edicao_atual_id;
	...
	public Edicao_Atual(String temporada, String nome, String nome_popular, String slug) {
		super();
	...
	public Edicao_Atual(int edicao_atual_id, String temporada, String nome, String nome_popular, String slug) {
		super();
	...
	public int getEdicao_atual_id() {
		return edicao_atual_id;
	}

	public void setEdicao_atual_id(int edicao_atual_id) {
		this.edicao_atual_id = edicao_atual_id;
	}
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + edicao_atual_id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Edicao_Atual other = (Edicao_Atual) obj;
